...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tabs',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="booksPage" tabTitle="Livres" tabIcon="book"></ion-tab>\n  <ion-tab [root]="cdsPage" tabTitle="Cds"    tabIcon="disc"></ion-tab>\n</ion-tabs>'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\tabs\tabs.html"*/,
        })
    ], TabsPage);
    return TabsPage;
}());
...
var BookListPage = /** @class */ (function () {
    ...
    BookListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-book-list',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\book-list\book-list.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>Livres</ion-title>\n	<ion-buttons start>\n      <button ion-button icon-only (click)="onToggleMenu()">\n        <ion-icon name="menu"></ion-icon>\n      </button>\n  </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <button ion-item\n            icon-start\n            *ngFor="let book of booksList; let i = index"\n			[color]="book.isLend ? \'secondary\' : \'danger\'"\n            (click)="onLoadBook(i)">\n      {{ book.name }}\n    </button>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\book-list\book-list.html"*/,
        }),
...
var LendBookPage = /** @class */ (function () {
    ...
    LendBookPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-lend-book',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\lend-book\lend-book.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-buttons>\n      <button ion-button clear (click)="dismissModal()">Fermer</button>\n    </ion-buttons>\n    <ion-title>{{ book.name }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card [ngClass]="{\'is-lend-on\': book.isLend, \'is-lend-off\': !book.isLend}">\n    <ion-card-header>{{ book.name }}</ion-card-header>\n    <ion-card-content>\n		Ecrit par {{ book.author }} en {{ book.year }}\n    </ion-card-content>\n    <ion-grid>\n      <ion-row>\n        <ion-col>\n          <button\n            ion-button\n            full\n            color="danger"\n            [disabled]="!book.isLend"\n            (click)="onToggleBook()">Prêter</button>\n        </ion-col>\n        <ion-col>\n          <button\n            ion-button\n            full\n            color="secondary"\n            [disabled]="book.isLend"\n            (click)="onToggleBook()">Rendre</button>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\lend-book\lend-book.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ViewController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ViewController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_bookAndCd_service__["a" /* BookAndCdService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_bookAndCd_service__["a" /* BookAndCdService */]) === "function" && _c || Object])
    ], LendBookPage);
    return LendBookPage;
    var _a, _b, _c;
}());
...
var CdListPage = /** @class */ (function () {
    ...
    CdListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-cd-list',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\cd-list\cd-list.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>CDs</ion-title>\n	<ion-buttons start>\n      <button ion-button icon-only (click)="onToggleMenu()">\n        <ion-icon name="menu"></ion-icon>\n      </button>\n  </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-list>\n    <button ion-item\n            icon-start\n            *ngFor="let cd of cdsList; let i = index"\n			[color]="cd.isLend ? \'secondary\' : \'danger\'"\n            (click)="onLoadCD(i)">\n      {{ cd.name }}\n    </button>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\cd-list\cd-list.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_2__services_bookAndCd_service__["a" /* BookAndCdService */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* MenuController */]])
...
var LendCdPage = /** @class */ (function () {
    ...
    LendCdPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-lend-cd',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\lend-cd\lend-cd.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-buttons>\n      <button ion-button clear (click)="dismissModal()">Fermer</button>\n    </ion-buttons>\n    <ion-title>{{ cd.name }}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-card [ngClass]="{\'is-lend-on\': cd.isLend, \'is-lend-off\': !cd.isLend}">\n    <ion-card-header>{{ cd.name }}</ion-card-header>\n    <ion-card-content>\n		Artiste {{ cd.author }}, composé en {{ cd.year }}\n    </ion-card-content>\n    <ion-grid>\n      <ion-row>\n        <ion-col>\n          <button\n            ion-button\n            full\n            color="danger"\n            [disabled]="!cd.isLend"\n            (click)="onToggleBook()">Prêter</button>\n        </ion-col>\n        <ion-col>\n          <button\n            ion-button\n            full\n            color="secondary"\n            [disabled]="cd.isLend"\n            (click)="onToggleBook()">Rendre</button>\n        </ion-col>\n      </ion-row>\n    </ion-grid>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\lend-cd\lend-cd.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ViewController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ViewController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_bookAndCd_service__["a" /* BookAndCdService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_bookAndCd_service__["a" /* BookAndCdService */]) === "function" && _c || Object])
    ], LendCdPage);
    return LendCdPage;
...
var SettingsPage = /** @class */ (function () {
    ...
    SettingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-settings',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\settings\settings.html"*/'<ion-header>\n\n  <ion-navbar>\n    <ion-title>Réglages</ion-title>\n	<ion-buttons start>\n      <button ion-button icon-only (click)="onToggleMenu()">\n        <ion-icon name="menu"></ion-icon>\n      </button>\n  </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\nCeci  est une page générique pour les réglages de l\'application\n</ion-content>\n'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\settings\settings.html"*/,
        }),
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n  <ion-content>\n    <ion-list>\n	<button ion-button icon-start (click)="onNavigate(tabsPage)">\n        <ion-icon name="book"></ion-icon>\n		<ion-icon name="disc"></ion-icon>\n         Livres & Cds\n      </button>\n      <button ion-button icon-start (click)="onNavigate(settingsPage)">\n        <ion-icon name="settings"></ion-icon>\n         Réglages\n      </button>\n    </ion-list>\n  </ion-content>\n</ion-menu>\n<ion-nav [root]="tabsPage" #content></ion-nav>'/*ion-inline-end:"D:\CompoSelector\books-activity\src\app\app.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"D:\CompoSelector\books-activity\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Ionic Blank\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  The world is your oyster.\n  <p>\n    If you get lost, the <a href="http://ionicframework.com/docs/v2">docs</a> will be your guide.\n  </p>\n</ion-content>\n'/*ion-inline-end:"D:\CompoSelector\books-activity\src\pages\home\home.html"*/
        }),
